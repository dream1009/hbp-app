<template>
  <div>
    <selector
      ...
      :root-name="$t('components.selector.position')"
...
<script>
import { queryByParentId, getPositionById } from '@/api/platform/org/position'
