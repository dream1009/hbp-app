HBP 平台采用本地构建vant的样式
1、下载代码
  https://github.com/youzan/vant/tree/dev/packages/vant-css


2、移除代码
①、src下找到base.css
  移除下面内容 @import './icon.css';

3、（选用）如果变量采用不一样可以采用这方式
  修改 src/common/var.css 中的颜色变量 替换按钮颜色
  主要修改 button-primary的样式
...
info.css 字体太大 替换成0.5
van-info{ont-size:.5em;}
